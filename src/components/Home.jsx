...
const Home = () => {
  ...
  const handleResumeClick = (e) => {
    e.preventDefault();
    const viewUrl = 'https://drive.google.com/file/d/1To6D-KPsTM8VnkHsnG2UTXVYfJOdd1hC/view?usp=sharing';
    const downloadUrl = 'https://drive.google.com/uc?export=download&id=1To6D-KPsTM8VnkHsnG2UTXVYfJOdd1hC';
